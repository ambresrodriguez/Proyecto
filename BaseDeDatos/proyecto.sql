...
insert into eventos values(1,'15-06-2026','constelaciones','gijón','Una obra de teatro contemporánea que 
                                    explora la relacion entre una fìsica cuántica y un apicultor');
insert into eventos values(2,'05-06-2026','mujeres en la musica','gijón','Exposicion que reúne imágenes 
                                    y materiales de artistas como Rocio Jurado o Aitana');
insert into eventos values(3,'02-10-2026','the silence','gijón','Para su obra autoficticoa
                            el dramaturgo y director Flak Richter se centra en su propia historia familiar');
insert into eventos values(4,'06-04-2026','fiesta del bollo','avilés','celebración primaveral
                        con desfiles, comida en la calle y ambiente festivo que cierra la Semana Santa.');
insert into eventos values(5,'24-03-2026','mamma mia','teatro jovellanos, gijón','comedia 
                                romántica con canciones de ABBA sobre una boda y un misterio familiar.');
insert into eventos values(6,'01-01-2026','oviedo-español','estadio municipal carlos tartiere, oviedo','un 
                                                        partido de liga entre el oviedo y el español');
